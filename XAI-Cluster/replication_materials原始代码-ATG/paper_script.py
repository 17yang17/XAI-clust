...
# 数值和分类变量列表 
# Numerical and categorical variable lists
num_vars = ['AGE', 'TARDYSD', 'EXERPRAC', 'STUDYHMW', 'WORKPAY', 'WORKHOME', 'MATHEASE', 'DURECEC', 'BSMJ', 'RELATST', 'BELONG', 'BULLIED', 'PERSEVAGR', 'CURIOAGR', 'COOPAGR', 'EMPATAGR', 'ASSERAGR', 'STRESAGR', 'EMOCOAGR', 'FAMSUP', 'DISCLIM', 'TEACHSUP', 'COGACRCO', 'COGACMCO', 
'EXPOFA', 'EXPO21ST', 'MATHEFF', 'MATHEF21', ##'FAMCON',
 'ANXMAT', 'MATHPERS', 'SCHSUST', 'LEARRES', 'PROBSELF', 'FAMSUPSL', 'SDLEFF', 'PAREDINT', 'BMMJ1', 'BFMJ2', 'HISEI', 'HOMEPOS', 'ESCS', 'ICTSCH', 'ICTAVSCH', 'ICTHOME', 'ICTAVHOM', 'ICTQUAL', 'ICTSUBJ', 'ICTENQ', 'ICTFEED', 
'ICTOUT', 'ICTWKDY', 'ICTWKEND', 'ICTREG', 'ICTINFO', 'ICTDISTR', 'ICTEFFIC'#, 'STUBMI', 'BODYIMA', 'SOCONPA', 'LIFESAT', 'PSYCHSYM', 'SOCCON', 'EXPWB'
]
cat_vars = ['ST004D01T', 'IMMIG', 'LANGN', 'REPEAT', 'SKIPPING', 'EXPECEDU', 'MATHPREF', 'MATHMOT', 'SISCO', 'HISCED']

# Load data # 加载数据
# df = pd.read_csv('data/pisa_spain_sample_v2.csv')
df = pd.read_csv('F:\\毕设\malgar-clust-learn-master\\replication_materials2\\data\\Taibei_STU_QQQ.csv')
# print(df)
...
plot_imputation_distribution_assessment(df.loc[df_imp.index], df_imp, ['COMPICT', 'MATHPERS', 'PERCOOP', 'ICTOUT'],
